export interface Env {
  ...
  DISCORD_ROLE_CREATOR_MEMBER_ID?: string;
  DISCORD_GUILD_ID_LABS?: string;
  DISCORD_ROLE_LABS_PARTNER_ID?: string;
  DISCORD_ROLE_LABS_ADMIN_ID?: string;
  DISCORD_ROLE_LABS_LABS_ID?: string;
  DISCORD_ROLE_LABS_INSTITUTE_ID?: string;
  DISCORD_ROLE_LABS_BUSINESS_ID?: string;
...
export function getEnv(env: Record<string, unknown>): Env {
  return {
    ...
    DISCORD_ROLE_CREATOR_MEMBER_ID: optionalString(env.DISCORD_ROLE_CREATOR_MEMBER_ID),
    DISCORD_GUILD_ID_LABS: optionalString(env.DISCORD_GUILD_ID_LABS),
    DISCORD_ROLE_LABS_PARTNER_ID: optionalString(env.DISCORD_ROLE_LABS_PARTNER_ID),
    DISCORD_ROLE_LABS_ADMIN_ID: optionalString(env.DISCORD_ROLE_LABS_ADMIN_ID),
    DISCORD_ROLE_LABS_LABS_ID: optionalString(env.DISCORD_ROLE_LABS_LABS_ID),
    DISCORD_ROLE_LABS_INSTITUTE_ID: optionalString(env.DISCORD_ROLE_LABS_INSTITUTE_ID),
    DISCORD_ROLE_LABS_BUSINESS_ID: optionalString(env.DISCORD_ROLE_LABS_BUSINESS_ID),
