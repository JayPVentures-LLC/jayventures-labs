# Repository Status: Non-Production for JPV Nexus

This repository (`JayPVentures-LLC/jayventures-labs`) is **not** the production source of truth for JPV Nexus.

## Nexus Production Source of Truth

- Production Nexus repository: `jaypVLabs/JPV-OS`
- Do **not** run or route JPV Nexus production deployment from this repository.
