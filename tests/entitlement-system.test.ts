...
function createRawEnv() {
  ...
  return {
    raw: {
      ...
      DISCORD_GUILD_ID_CREATOR: "guild-creator",
      DISCORD_ROLE_CREATOR_COMMUNITY_ID: "role-creator-member",
      DISCORD_ROLE_CREATOR_VIP_ID: "role-creator-vip",
      DISCORD_GUILD_ID_LABS: "guild-labs",
      DISCORD_ROLE_LABS_MEMBER_ID: "role-labs-member",
      DISCORD_ROLE_LABS_RESEARCHER_ID: "role-labs-researcher",
      DISCORD_ROLE_LABS_STUDENT_ID: "role-labs-student",
