...
function createRawEnv() {
  ...
  return {
    raw: {
      ...
      DISCORD_GUILD_ID_CREATOR: "guild-creator-test",
      DISCORD_ROLE_CREATOR_COMMUNITY_ID: "community_free",
      DISCORD_ROLE_CREATOR_VIP_ID: "vip_role_test",
      DISCORD_GUILD_ID_LABS: "guild-labs-test",
      DISCORD_ROLE_LABS_MEMBER_ID: "labs_member_test",
      DISCORD_ROLE_LABS_RESEARCHER_ID: "labs_researcher_test",
      DISCORD_ROLE_LABS_STUDENT_ID: "labs_student_test",
